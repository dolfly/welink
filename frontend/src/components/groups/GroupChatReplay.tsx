...
import { Play, Pause, SkipForward, Clock, Gauge, Maximize2, Minimize2, Sparkles } from 'lucide-react';
    ...
    >
      <div className="flex items-center justify-between mb-3">
        <div className="text-xs text-gray-500">
          {fullscreen && <span className="font-bold text-[#1d1d1f] dark:text-gray-100 mr-2">{groupName}</span>}
      ...
      {loaded && (
        <>
          <div ref={scrollRef} className={`flex-1 overflow-y-auto py-2 space-y-3 bg-[#f0f0f0] dark:bg-gray-900/50 rounded-2xl px-3 ${fullscreen ? 'min-h-0' : 'max-h-[50vh]'}`}>
